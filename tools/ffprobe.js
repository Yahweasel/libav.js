...
const LibAV = require("../dist/libav-4.7.6.0.1-all.js");
const fs = require("fs/promises");

async function main() {
    if (process.argv.length < 4) {
        console.error(
            "Use: ffprobe.js <input file> [ffprobe arguments, which must include at least\n" +
            "     in]\n\n" +
    ...
    // Do it
    const ret = await libav.ffprobe(process.argv.slice(3));
