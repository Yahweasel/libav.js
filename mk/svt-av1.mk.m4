...
define([[[buildrule]]], [[[
build/SVT-AV1-v$(SVT_AV1_VERSION)/build-$1/Makefile: $2 build/SVT-AV1-v$(SVT_AV1_VERSION)/PATCHED | build/inst/$1/cflags.txt
	...
	cd build/SVT-AV1-v$(SVT_AV1_VERSION)/build-$1 && \
		...
		-DCMAKE_C_FLAGS="-Oz `cat $(PWD)/build/inst/$1/cflags.txt` $4" \
		-DCMAKE_CXX_FLAGS="-Oz `cat $(PWD)/build/inst/$1/cflags.txt` $4" \
...
# Non-threaded
buildrule(base, build/inst/base/lib/libemfiberthreads.a, -DEMFIBERTHREADS=1, [[[-I$(PWD)/build/inst/base/include -L$(PWD)/build/inst/base/lib]]])
# Threaded
buildrule(thr, [[[]]], [[[]]], [[[]]])
